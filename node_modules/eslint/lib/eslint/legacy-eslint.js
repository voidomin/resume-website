...
function processOptions({
	allowInlineConfig = true, // â† we cannot use `overrideConfig.noInlineConfig` instead because `allowInlineConfig` has side-effect that suppress warnings that show inline configs are ignored.
	baseConfig = null,
	cache = false,
	...
	extensions = null, // â† should be null by default because if it's an array then it suppresses RFC20 feature.
	fix = false,
	fixTypes = null, // â† should be null by default because if it's an array then it suppresses rules that don't have the `meta.type` property.
	flags /* eslint-disable-line no-unused-vars -- leaving for compatibility with ESLint#hasFlag */,
	globInputPaths = true,
	ignore = true,
	ignorePath = null, // â† should be null by default because if it's a string then it may throw ENOENT.
	overrideConfig = null,
