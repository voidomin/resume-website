		...
		*/
		return function generate(localName, filepath) {
			...
			return interpolateName({ resourcePath: filepath }, name, {
				...
				context
			}).replace(new RegExp("[^a-zA-Z0-9\\-_\xA0-ï¿¿]", "g"), "-").replace(/^((-?[0-9])|--)/, "_$1");
		};
	};
}));
...
var require_unesc = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	*/
	function gobbleHex(str$1) {
		...
		if (codePoint >= 55296 && codePoint <= 57343 || codePoint === 0 || codePoint > 1114111) return ["ï¿½", hex$1.length + (spaceTerminated ? 1 : 0)];
