...
function logMissingGlobalName(externalId, guess) {
    return {
        ...
        id: externalId,
        message: `No name was provided for external module "${externalId}" in "output.globals" â€“ guessing "${guess}".`,
        names: [guess],
...
function logUnresolvedImportTreatedAsExternal(source, importer) {
    return {
        ...
        exporter: source,
        id: importer,
        message: `"${source}" is imported by "${relativeId(importer)}", but could not be resolved â€“ treating it as an external dependency.`,
